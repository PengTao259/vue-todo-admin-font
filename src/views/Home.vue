  ...
  <div class="home-container">
    ...
    <div class="content clearfix">
      <div class="list">
        ...
        <span>
          <Button style="margin-right:20px" type="success" @click="loadData">刷新</Button>
          <Button type="primary" icon="md-add"  @click="addTask">添加任务</Button>
        </span>
      </div>
